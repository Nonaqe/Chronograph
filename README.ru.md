...
Файл `LICENSE` пока не добавлен. Добавьте его (например, MIT или Apache‑2.0) до широкого распространения; модель распространения через Action предполагает публичный open‑source‑проект.
